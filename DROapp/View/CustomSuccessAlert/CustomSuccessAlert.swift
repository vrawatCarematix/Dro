...
@objc protocol CustomSuccessAlertDelegate {

    @objc optional func clickOnOKButton(_ sender:CustomSuccessAlert)
}
class CustomSuccessAlert: UIView {

    @IBOutlet weak var labalTitle: UILabel!
    @IBOutlet weak var labelMessage: UILabel!
    @IBOutlet weak var alertView: CardView!
    @IBOutlet weak var buttonOk: UIButton!
   weak var delegate: CustomSuccessAlertDelegate?
    ...
    class func instanceFromNib(message : String) -> UIView {
       let view = UINib(nibName: "CustomSuccessAlert", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! CustomSuccessAlert
    ...
    class func instanceFromNib(title : String , message : String , okButtonTitle : String ,type : AlertType ) -> UIView {
        ...
        if type == .error {
            ...
            view.labalTitle.textColor = UIColor.black
