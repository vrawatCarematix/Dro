    ...
    private class ImageOnlySegmentCollectionViewCell: BaseSegmentCollectionViewCell {
        ...
        override var contentColor:UIColor? {
            didSet {
                ...
                contentView.backgroundColor = (contentColor == nil) ? BaseSegmentCollectionViewCell.defaultTextColor : contentColor!
        ...
        override var isSelected: Bool {
            didSet {
                if isSelected {
                    imageView.tintColor = (selectedContentColor == nil) ? BaseSegmentCollectionViewCell.defaultTextColor : selectedContentColor!
                    contentView.backgroundColor = (selectedContentColor == nil) ? BaseSegmentCollectionViewCell.defaultTextColor : selectedContentColor!
        ...
        override func configure(){
            ...
            imageView.topAnchor.constraint(greaterThanOrEqualTo: contentView.topAnchor, constant: BaseSegmentCollectionViewCell.textPadding).isActive = true
            contentView.bottomAnchor.constraint(greaterThanOrEqualTo: imageView.bottomAnchor, constant: BaseSegmentCollectionViewCell.textPadding).isActive = true
        }
    }
