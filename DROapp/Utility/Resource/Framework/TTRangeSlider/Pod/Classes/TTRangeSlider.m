...
- (void)initialiseControl {
    ...
    _handleBorderColor = [UIColor redColor];
    ...
    self.leftHandle.borderWidth = 6;
    self.leftHandle.borderColor = [UIColor lightGrayColor].CGColor;
    ...
    self.rightHandle.borderColor = [UIColor lightGrayColor].CGColor;
